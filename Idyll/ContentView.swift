...
struct ContentView_Previews: PreviewProvider {
    static var previews: some View {
        ContentView(totalAmt: 100, resources: Array(idyllResources[0...2]), amounts: idyllResources.map { _ in Double(9000) }, purchasedAmounts: idyllResources.map { _ in Double(24) }, perSecond: 2000)
    }
}
